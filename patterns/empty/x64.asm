...
0000000000400274 <.note.gnu.build-id>:
  ...
  400283:	00 9b 80 81 98 f8    	add    BYTE PTR [rbx-0x7677e80],bl
  400289:	9d                   	popf   
  40028a:	2e f1                	cs icebp 
  40028c:	22 cf                	and    cl,bh
  40028e:	74 94                	je     400224 <_init-0x16c>
  400290:	9d                   	popf   
  400291:	81 01 9b 15 a0 52    	add    DWORD PTR [rcx],0x52a0159b
  400297:	95                   	xchg   ebp,eax
...
00000000004003b0 <_start>:
  ...
  4003bd:	50                   	push   rax
  4003be:	54                   	push   rsp
  4003bf:	49 c7 c0 20 05 40 00 	mov    r8,0x400520
  4003c6:	48 c7 c1 b0 04 40 00 	mov    rcx,0x4004b0
...
0000000000400534 <__GNU_EH_FRAME_HDR>:
  ...
  400541:	fe                   	(bad)  
  400542:	ff                   	(bad)  
  400543:	ff 4c 00 00          	dec    DWORD PTR [rax+rax*1+0x0]
  400547:	00 ac fe ff ff 78 00 	add    BYTE PTR [rsi+rdi*8+0x78ffff],ch
  40054e:	00 00                	add    BYTE PTR [rax],al
  400550:	63 ff                	movsxd edi,edi
  400552:	ff                   	(bad)  
  400553:	ff 8c 00 00 00 7c ff 	dec    DWORD PTR [rax+rax*1-0x840000]
  40055a:	ff                   	(bad)  
  40055b:	ff ac 00 00 00 ec ff 	jmp    FWORD PTR [rax+rax*1-0x140000]
  400562:	ff                   	(bad)  
  400563:	ff f4                	push   rsp
  400565:	00 00                	add    BYTE PTR [rax],al
	...

Disassembly of section .eh_frame:

0000000000400568 <__FRAME_END__-0xd4>:
  ...
  4005c9:	fe                   	(bad)  
  4005ca:	ff                   	(bad)  
  4005cb:	ff 0b                	dec    DWORD PTR [rbx]
  4005cd:	00 00                	add    BYTE PTR [rax],al
  4005cf:	00 00                	add    BYTE PTR [rax],al
  4005d1:	41 0e                	rex.B (bad) 
  4005d3:	10 86 02 43 0d 06    	adc    BYTE PTR [rsi+0x60d4302],al
  4005d9:	46 0c 07             	rex.RX or al,0x7
  4005dc:	08 00                	or     BYTE PTR [rax],al
  4005de:	00 00                	add    BYTE PTR [rax],al
  4005e0:	44 00 00             	add    BYTE PTR [rax],r8b
  4005e3:	00 50 00             	add    BYTE PTR [rax+0x0],dl
  4005e6:	00 00                	add    BYTE PTR [rax],al
  4005e8:	c8 fe ff ff          	enter  0xfffe,0xff
  4005ec:	65 00 00             	add    BYTE PTR gs:[rax],al
  4005ef:	00 00                	add    BYTE PTR [rax],al
  4005f1:	42 0e                	rex.X (bad) 
  4005f3:	10 8f 02 42 0e 18    	adc    BYTE PTR [rdi+0x180e4202],cl
  4005f9:	8e 03                	mov    es,WORD PTR [rbx]
  4005fb:	45 0e                	rex.RB (bad) 
  4005fd:	20 8d 04 42 0e 28    	and    BYTE PTR [rbp+0x280e4204],cl
  400603:	8c 05 48 0e 30 86    	mov    WORD PTR [rip+0xffffffff86300e48],es        # ffffffff86701451 <_end+0xffffffff86100421>
  400609:	06                   	(bad)  
  40060a:	48 0e                	rex.W (bad) 
  40060c:	38 83 07 4d 0e 40    	cmp    BYTE PTR [rbx+0x400e4d07],al
  400612:	72 0e                	jb     400622 <__GNU_EH_FRAME_HDR+0xee>
  400614:	38 41 0e             	cmp    BYTE PTR [rcx+0xe],al
  400617:	30 41 0e             	xor    BYTE PTR [rcx+0xe],al
  40061a:	28 42 0e             	sub    BYTE PTR [rdx+0xe],al
  40061d:	20 42 0e             	and    BYTE PTR [rdx+0xe],al
  400620:	18 42 0e             	sbb    BYTE PTR [rdx+0xe],al
  400623:	10 42 0e             	adc    BYTE PTR [rdx+0xe],al
  400626:	08 00                	or     BYTE PTR [rax],al
  400628:	10 00                	adc    BYTE PTR [rax],al
  40062a:	00 00                	add    BYTE PTR [rax],al
  40062c:	98                   	cwde   
  40062d:	00 00                	add    BYTE PTR [rax],al
  40062f:	00 f0                	add    al,dh
  400631:	fe                   	(bad)  
  400632:	ff                   	(bad)  
  400633:	ff 02                	inc    DWORD PTR [rdx]
  400635:	00 00                	add    BYTE PTR [rax],al
  400637:	00 00                	add    BYTE PTR [rax],al
  400639:	00 00                	add    BYTE PTR [rax],al
	...

000000000040063c <__FRAME_END__>:
