...
## Date: July 26, 2019
##
## Receives a list of numbers from stdin and sorts them in ascending order using merge sort.
## Performs the sort with both a recursive and an iterative algorithm.
##
...
main:
	...
	m_sort_recursive:
		...
		la			$a0, recursive_msg							# print "Sorting using a recursive algorithm..\n"
		li			$v0, 4
		syscall
		li			$a0, 0xA
		li			$v0, 11
	...
	m_sort_iterative:
		...
		la			$a0, iterative_msg							# print "Sorting using an iterative algorithm.."
		li			$v0, 4
		syscall
			
		la			$a0, list
		jal			sort.iterative_sort
