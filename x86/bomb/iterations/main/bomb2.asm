...
; =====================================
; File pointer being stored at 0x804b664
; Placeholder (?) being stored there if no file arg.
; MAIN80 
...
; Print a message. String located at 0x8049660
; Welcome to my fiendish bomb..
...
; print another message. String located at 0x80496a0
; with which to blow yourself up..
...
; call phase_1 passing the return value from read_line (eax)
 8048a5a:	50                   	push   eax
...
; repeat this process for all phases..
